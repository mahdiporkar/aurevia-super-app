...
@Component class LegacyTokenResponseParser {
 ...
 record Parsed(String accessToken,String refreshToken,String tokenType,Instant expiresAt){@Override public String toString(){return "Parsed[REDACTED]";}}
}
