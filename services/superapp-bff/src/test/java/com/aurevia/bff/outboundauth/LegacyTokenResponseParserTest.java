...
class LegacyTokenResponseParserTest {
 ...
 private OutboundAuthProfile profile(long max){return new OutboundAuthProfile("p",OutboundAuthMode.LEGACY_SERVICE_TOKEN,"connection://x","/token","JSON","secret://x",null,null,"/access_token","/expires_in","/token_type","Bearer","INTERNAL_LEGACY_HEADER",30,1000,1000,max,1);}
