  ...
  SELECT $manifest$
{
  ...
  "routes": [
    ...
    { "key": "users", "path": "users", "title": "مدیریت کاربران", "requiredResource": "application:aurevia", "requiredAction": "admin" },
  ...
  "navigation": [
    ...
    { "key": "users-menu", "type": "PAGE", "routeKey": "users", "title": "مدیریت کاربران", "description": "ایجاد کاربر جدید در Keycloak از پنل مدیریت بدون دسترسی مستقیم مرورگر به Keycloak", "icon": "user-add", "order": 95 },
