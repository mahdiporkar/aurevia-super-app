...
public final class PanelModels {
  ...
  public record PanelView(UUID id,String code,String nameFa,String nameEn,String description,
      ...
      String integrity,String resourceDefinitionMode,String classification,String mfManifestUrl,
      String resourceManifestUrl,boolean active,int sortOrder,UUID activeArtifactId,long version) {}
  @JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
  ...
  public record PanelCommand(String code,String nameFa,String nameEn,String description,String slug,
      ...
      String exposedModule,String routeBasePath,String semanticVersion,String contractVersion,
      String integrity,String resourceDefinitionMode,String classification,String mfManifestUrl,
      String resourceManifestUrl,boolean active,int sortOrder) {}
  public record PanelSettings(String serviceSlug,String remoteName,String defaultRouteId,
      String resourceDefinitionMode,String classification,String mfManifestUrl,
      String resourceManifestUrl) {}
