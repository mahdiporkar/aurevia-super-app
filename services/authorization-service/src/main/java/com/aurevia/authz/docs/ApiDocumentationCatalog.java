...
final class ApiDocumentationCatalog {
  ...
  private static Map<String, String> summaries() {
    ...
    put(m, "UiPluginRegistryController", "artifacts", "فهرست نسخه‌های Artifact میکروفرانت", "publish", "انتشار و اعتبارسنجی Artifact", "activate", "فعال‌سازی نسخه Artifact", "menu", "ثبت override منوی قدیمی میکروفرانت", "navigationOverrides", "فهرست Navigation Overlayهای راهبر", "navigation", "ثبت Navigation Overlay یا گره ادمین", "removeNavigation", "حذف Navigation Overlay یا گره ادمین");
