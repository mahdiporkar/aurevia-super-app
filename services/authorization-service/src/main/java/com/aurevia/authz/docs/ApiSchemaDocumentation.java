...
final class ApiSchemaDocumentation {
  ...
  private static final Map<String, String> FIELDS = Map.ofEntries(
      ...
      Map.entry("serviceslug", "شناسه منطقی سرویس؛ Path Prefix می‌تواند مستقل و دلخواه باشد."),
      ...
      Map.entry("remoteentry", "URL فایل remoteEntry.js؛ می‌تواند خارج از شبکه Docker باشد و تابع policy شبکه محیط است."),
      Map.entry("remoteentryurl", "URL فایل remoteEntry.js؛ می‌تواند خارج از شبکه Docker باشد و تابع policy شبکه محیط است."),
      ...
      Map.entry("gatewaybaseurl", "origin تأییدشده Operation Gateway؛ باید در allowlist استقرار BFF باشد."),
      ...
      Map.entry("outboundauthprofileid", "پروفایل احراز هویت همان Route؛ FORWARD_USER_TOKEN یا LEGACY_SERVICE_TOKEN."),
