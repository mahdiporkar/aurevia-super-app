...
class ProductionOpenFgaConfigurationGuardTest {
  ...
  void acceptsAnExplicitPinnedIdentifier() {
    ...
    assertDoesNotThrow(() ->
        ProductionOpenFgaConfigurationGuard
            .requireProductionValue(
                "OPENFGA_MODEL_ID",
                "01M17FCAYW1S6Z347FDR025TND"
            )
    );
  }

  @Test
  void rejectsDestructiveStartupRepairWithoutExplicitProductionOptIn() {
  ...
  @Test
  void acceptsNormalProductionStartupWithoutReconciliation() {
  ...
  @Test
  void acceptsExplicitlyApprovedProductionStartupRepair() {
