...
زمان اجرای نهایی: 2026-09-12T17:50:42.406Z. این گزارش از خروجی واقعی runner و فایل‌های Surefire تولید شده است. نتیجهٔ اجرای زنده: **PASS=41، FAIL=0، BLOCKED=0**.
...
```json
{
  ...
  "module": {
    "key": "test-legacy",
    "name": "Legacy Test",
    "nameFa": "آزمایش Legacy",
    "nameEn": "Legacy Test",
    "version": "0.1.0"
  },
  "resources": [
    {
      "key": "page:test-legacy.home",
      "type": "PAGE",
      "name": "Legacy Test",
      "nameFa": "آزمایش Legacy",
      "nameEn": "Legacy Test",
...
```json
{
  ...
  "identity": {
    ...
    "subject": "022bad84-4734-4f32-980c-94e9639e7366",
    "username": "e2e.dual-access"
  },
  "tenant": {
    "id": "default"
  },
  ...
  "allowedMicros": [
    {
      "registrationId": "21b69783-ddc7-4083-a14d-9afbc4114ac7",
      "moduleKey": "test-legacy",
      "displayName": "آزمایش legacy",
      "displayNameEn": "legacy Test",
      "description": "Independent authentication E2E fixture",
      "order": 110,
      "routePrefix": "test-legacy",
      "defaultRouteId": "home",
      "remote": {
        "remoteEntryUrl": "/api/mfe/test-legacy/remoteEntry.js",
        "remoteName": "aurevia_test_legacy",
        "exposedModule": "./plugin",
        "contractVersion": "1.0",
        "artifactVersion": "0.1.0"
      },
      "runtime": {
        "apiBasePath": "/api/proxy/test-legacy"
      },
      "routes": [
        {
          "id": "home",
          "path": "home",
          "title": "Legacy Test",
          "resource": "page:test-legacy.home",
          "action": "view"
        }
      ],
      "menus": [
      ...
      "manifestUrl": "/api/mfe/test-legacy/manifest.json"
    },
    {
      "registrationId": "822bb713-5d65-4e94-8dd2-3234d9ab9602",
      "moduleKey": "test-sso",
      "displayName": "آزمایش sso",
      "displayNameEn": "sso Test",
      "description": "Independent authentication E2E fixture",
      "order": 110,
      "routePrefix": "test-sso",
      "defaultRouteId": "home",
      "remote": {
        "remoteEntryUrl": "/api/mfe/test-sso/remoteEntry.js",
        "remoteName": "aurevia_test_sso",
        "exposedModule": "./plugin",
        "contractVersion": "1.0",
        "artifactVersion": "0.1.0"
      },
      "runtime": {
        "apiBasePath": "/api/proxy/test-sso"
      },
      "routes": [
        {
          "id": "home",
      ...
      "classification": "DEMO",
      "resourceDefinitionMode": "MANIFEST",
      "manifestUrl": "/api/mfe/test-sso/manifest.json"
    }
  ],
  "dynamicRoutes": [
    {
  ...
  "actions": {
    "application:aurevia/test-legacy": [
      "view"
    ],
    "application:aurevia/test-sso": [
      "view"
    ],
    "module:test-legacy": [
      "view"
...
evidence نهایی هم‌بستگی: {"correlationId":"ec65a5e4-46b5-4c7b-ad24-a8be368b3cbb","bff":true,"downstream":true,"storedEntries":3}. همان UUID در header/request و پاسخ downstream، log BFF، log test-sso-service و /api/v1/admin/logs/correlation/{id} موجود است. storedEntries تعداد رکوردهای واقعاً خوانده‌شده از API audit است.

## 24. ماتریس آزمون‌ها

جدول دسترسی (visibility context و backend HTTP، هر دو در همان تست):

| شناسه | نمایش در context | HTTP | وضعیت |
|---|---|---:|---|
| AUTH-DUAL-SSO | true | 200 | PASS |
| AUTH-DUAL-LEGACY | true | 200 | PASS |
| AUTH-SSO-SSO | true | 200 | PASS |
| AUTH-SSO-LEGACY | false | 403 | PASS |
| AUTH-LEGACY-SSO | false | 403 | PASS |
| AUTH-LEGACY-LEGACY | true | 200 | PASS |
| AUTH-NONE-SSO | false | 403 | PASS |
| AUTH-NONE-LEGACY | false | 403 | PASS |

تمام موردها، expected و actual و وضعیت مستقل آن‌ها:

| شناسه | انتظار | نتیجهٔ واقعی | وضعیت |
|---|---|---|---|
| ADMIN-SSO | Register panel, publish resources, sync UI, create profile/target/route/operations | "Admin APIs successful" | PASS |
| ADMIN-LEGACY | Register panel, publish resources, sync UI, create profile/target/route/operations | "Admin APIs successful" | PASS |
| AUTH-DUAL-SSO | Visible in effective context + downstream 200 | {"contextVisible":true,"httpStatus":200,"authMode":"SSO","correlationId":"faf7c9b0-e50c-4ff8-ae7a-878af7cf4570"} | PASS |
| AUTH-DUAL-LEGACY | Visible in effective context + downstream 200 | {"contextVisible":true,"httpStatus":200,"authMode":"LEGACY","correlationId":"f16854d0-32d4-4c5c-844a-3a1c701a4cfa"} | PASS |
| AUTH-SSO-SSO | Visible in effective context + downstream 200 | {"contextVisible":true,"httpStatus":200,"authMode":"SSO","correlationId":"81588b9c-5e18-42e9-8e2d-b696ade1213c"} | PASS |
| AUTH-SSO-LEGACY | Absent from context + backend 403 | {"contextVisible":false,"httpStatus":403,"correlationId":"812ed154-2578-4e4f-8fe5-030a6a63c777"} | PASS |
| AUTH-LEGACY-SSO | Absent from context + backend 403 | {"contextVisible":false,"httpStatus":403,"correlationId":"3c7063a4-58c5-42c8-bcea-79b099807f65"} | PASS |
| AUTH-LEGACY-LEGACY | Visible in effective context + downstream 200 | {"contextVisible":true,"httpStatus":200,"authMode":"LEGACY","correlationId":"ee046be8-1d71-4028-899e-f762e490d86a"} | PASS |
| AUTH-NONE-SSO | Absent from context + backend 403 | {"contextVisible":false,"httpStatus":403,"correlationId":"591430fd-e757-4e23-bdcb-658e74bd941a"} | PASS |
| AUTH-NONE-LEGACY | Absent from context + backend 403 | {"contextVisible":false,"httpStatus":403,"correlationId":"8836a550-9a4a-4223-aa6a-8e97a57828d9"} | PASS |
| ADMIN-UNAUTHORIZED | 403 for non-admin route creation | 403 | PASS |
| SSO-DATA | 200 | 200 | PASS |
| LEGACY-DATA | 200 | 200 | PASS |
| ROUTE-UNKNOWN | 404 | 404 | PASS |
| ROUTE-METHOD | 404 (no registered POST operation; CSRF included) | 404 | PASS |
| ROUTE-DISABLE | 404 without rebuild/restart | 404 | PASS |
| ROUTE-ENABLE | 200 without rebuild/restart | 200 | PASS |
| ROUTE-WRONG-DESTINATION | 400 unapproved destination | 400 | PASS |
| ROUTE-CONFIG-CHANGE | 404 after rewriting to nonexistent service path | 404 | PASS |
| ROUTE-CONFIG-RESTORE | 200 | 200 | PASS |
| ROUTE-UNAUTHENTICATED | 401 | 401 | PASS |
| SSO-MISSING | 401 | 401 | PASS |
| SSO-INVALID | 401 | 401 | PASS |
| SSO-LEGACY-CREDENTIAL | 401 | 401 | PASS |
| LEGACY-MISSING | 401 | 401 | PASS |
| LEGACY-INVALID | 401 | 401 | PASS |
| LEGACY-SSO-CREDENTIAL | 401 | 401 | PASS |
| LEGACY-TOKEN-ENDPOINT | 401 incorrect service password | 401 | PASS |
| SSO-EXPIRED | 401 for a real Keycloak-issued expired access token | 401 | PASS |
| LEGACY-CACHE | Server cache present after successful calls | {"cached":true,"missAndHit":true} | PASS |
| LEGACY-MISSING-SECRET | 502; fail closed | 502 | PASS |
| LEGACY-RESTORE-SECRET | 200 | 200 | PASS |
| SECURITY-RESPONSES | No downstream credentials in responses/context | "No credential material" | PASS |
| SECURITY-SERVER-SESSION | Opaque HttpOnly cookie resolves to token-free Redis identity | {"opaqueSession":true,"tokenMaterialInRedisSession":false} | PASS |
| SECURITY-NETWORK-ISOLATION | No backend or gateway host port | "No published downstream/gateway port" | PASS |
| AUDIT-CORRELATION | BFF decision/target/mode/result and downstream share correlation | {"correlationId":"ec65a5e4-46b5-4c7b-ad24-a8be368b3cbb","bff":true,"downstream":true,"storedEntries":3} | PASS |
| BROWSER-DUAL | Real Shell login, menus, MF requests, storage and network checks | {"checks":[{"mode":"sso","visible":true,"apiStatus":200},{"mode":"legacy","visible":true,"apiStatus":200}],"storageContainsCredentials":false,"bearerHeadersFromBrowser":false,"directDownstreamRequests":0,"apiRequestCount":10} | PASS |
| BROWSER-SSO-ONLY | Real Shell login, menus, MF requests, storage and network checks | {"checks":[{"mode":"sso","visible":true,"apiStatus":200},{"mode":"legacy","visible":false,"apiStatus":403}],"storageContainsCredentials":false,"bearerHeadersFromBrowser":false,"directDownstreamRequests":0,"apiRequestCount":7} | PASS |
| BROWSER-LEGACY-ONLY | Real Shell login, menus, MF requests, storage and network checks | {"checks":[{"mode":"sso","visible":false,"apiStatus":403},{"mode":"legacy","visible":true,"apiStatus":200}],"storageContainsCredentials":false,"bearerHeadersFromBrowser":false,"directDownstreamRequests":0,"apiRequestCount":7} | PASS |
| BROWSER-NONE | Real Shell login, menus, MF requests, storage and network checks | {"checks":[{"mode":"sso","visible":false,"apiStatus":403},{"mode":"legacy","visible":false,"apiStatus":403}],"storageContainsCredentials":false,"bearerHeadersFromBrowser":false,"directDownstreamRequests":0,"apiRequestCount":4} | PASS |
| SECURITY-LOGS | No known secrets or raw credentials in application/edge/identity logs | "No credential material found" | PASS |
...
|---|---:|---:|---:|
| Java، آخرین XML هر تست | 194 | 0 | 0 |
| npm test، اجراشده در این session | 42 | 0 | 0 |
| live E2E + Chrome | 41 | 0 | 0 |
| مجموع caseهای این سه suite | 277 | 0 | 0 |

Java detail: ui-artifact-security=7 (fail=0, skipped=0)؛ superapp-bff=57 (fail=0, skipped=0)؛ authorization-service=128 (fail=0, skipped=0)؛ test-sso-service=0 (fail=0, skipped=0)؛ test-legacy-service=2 (fail=0, skipped=0). Build و typecheckها موفق بودند و به عنوان case اضافی شمرده نشده‌اند. screenshotهای local و browser evidence در target/e2e-auth ذخیره شده‌اند؛ نتیجهٔ امن و قابل نگهداری در docs/evidence/e2e-sso-legacy-proxy-results.json کپی می‌شود. evidence JSON شامل expected/actual هر case، context و audit واقعی است.
