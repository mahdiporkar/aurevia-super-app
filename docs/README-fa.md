...
19. [معماری Resource Catalog و دو Manifest](resource-catalog-manifest-architecture-fa.md)
20. [Shell و بارگذاری Micro Frontendها](shell-runtime-and-mfe-loading-fa.md)
21. [دموی دسترسی چندصفحه‌ای HR و Finance](two-page-openfga-demo-fa.md)
22. [معماری فنی](architecture.md)
23. [حاکمیت Git و دسترسی](git-governance-fa.md)
24. [مدل تهدید](threat-model.md)
...
31. [گزارش اعتبارسنجی Production از دیتابیس خالی در ۲۰۲۶-۰۹-۰۸](production-fresh-stack-validation-2026-09-08-fa.md)
32. [استاندارد اجباری Manifest همه Micro Frontendها](microfrontend-manifest-contract-standard-fa.md)
33. [چرخهٔ مستقل Core/MFE و سیاست URL و SSRF](mfe-independent-lifecycle-fa.md)
...
| Core و MFEها چگونه مستقل اجرا می‌شوند و URL خارجی چگونه امن ثبت می‌شود؟ | [mfe-independent-lifecycle-fa.md](mfe-independent-lifecycle-fa.md) |
