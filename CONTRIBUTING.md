...
Run `npm run docs:verify` whenever architecture, API routes, services, migrations, MFE manifests,
or operational capabilities change. Living documentation must describe the code in the same
commit; date-stamped reports remain immutable evidence and must be labelled as historical.
