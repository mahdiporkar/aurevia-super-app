...
export interface EffectiveManifest { version:string; expiresAt:string; staleAt?:string; panels:PanelManifest[]; permissions:Record<string,readonly string[]>; presentation?:Record<string,PresentationMode>; }
