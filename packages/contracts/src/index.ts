...
export interface EffectiveManifest { manifestType?:'EFFECTIVE_USER_MANIFEST'; subject?:{type:'user';id:string}; version:string; expiresAt:string; staleAt?:string; panels:PanelManifest[]; permissions:Record<string,readonly string[]>; resourceTree?:ManifestResource[]; presentation?:Record<string,PresentationMode>; uiCatalog?:UiCatalog; }
